...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/1.jpg)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/1.png)

启动后安装推荐插件:

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/2.png)
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/3.png)
安装插件完成后，进入设置初始账号密码:

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/4.png)

设置完毕即可进入jenkins主页：

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/5.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/6.png)

进入全局工具配置，配置项目中会用到的nodejs版本，可以配置多个

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/7.png)

### jenkins + github 配置项目

开始创建项目，选择自由风格：

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/8.png)

开始配置项目（以github私有项目为例）

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/9.png)

此处我们填写完git地址后需要添加凭证，添加其他个人私有密钥不知道为啥一直在下拉菜单中选不到，添加用户名密码则可以，暂时还不知道啥原因~

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/10.png)

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/11.png)

触发器中我们选择hook，push之后，自动触发构建

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/12.png)

此处在github中也要做对应配置才可出发hook功能：
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/16.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/14.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/17.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/18.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/24.png)

2. 区分项目（不同服务提供商字段会有差异，腾讯云是在repository下）

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/25.png)

3. 配置token

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/26.png)

4. 过滤字段匹配项目（此处为每个项目特有配置，区分好项目与分支）

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/27.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/28.png)

首先需要在全局安全配置页面将授权策略改为：Role-Based Strategy

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/31.png)


进入 Manage Role 选项，配置用户角色与所在组角色权限

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/29.png)

进入 Assign Roles 选项，为用户分配角色（首先需要在用户管理板块创建用户）

![](/images/frontend-engineering/jenkins搭建前端上线系统小试/30.png)
...
![](/images/frontend-engineering/jenkins搭建前端上线系统小试/32.png)
