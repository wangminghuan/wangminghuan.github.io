...
确保`mongod.conf`中的dbpath与logpath对应目录存在，启动数据库：
...
![](/images/database/数据库系列-2-MongoDB/1.png)
...
![](/images/database/数据库系列-2-MongoDB/2.png)
...
![](/images/database/数据库系列-2-MongoDB/3.png)
...
![](/images/database/数据库系列-2-MongoDB/4.png)
...
![](/images/database/数据库系列-2-MongoDB/5.png)

### limit与skip方法
limit()方法接受一个数字参数，该参数指定从MongoDB中读取的记录条数。skip()方法来跳过指定数量的数据，skip方法同样接受一个数字参数作为跳过的记录条数：

![](/images/database/数据库系列-2-MongoDB/6.png)

### sort排序
sort() 方法可以通过参数指定排序的字段，并使用 1 和 -1 来指定排序的方式，其中 1 为升序排列，而 -1 是用于降序排列。

![](/images/database/数据库系列-2-MongoDB/7.png)
...
![](/images/database/数据库系列-2-MongoDB/8.png)
...
![](/images/database/数据库系列-2-MongoDB/./9.png)
### 导入数据
...
![](/images/database/数据库系列-2-MongoDB/./10.png)
