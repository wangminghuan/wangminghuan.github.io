...
![](/images/nodejs/你不知道的npm-init/./1.png)
...
![](/images/nodejs/你不知道的npm-init/./2.png)
...
![](/images/nodejs/你不知道的npm-init/./3.png)
...
![](/images/nodejs/你不知道的npm-init/./4.png)

但npx 出现以后，我们可以更优雅的执行本地命令

![](/images/nodejs/你不知道的npm-init/./5.png)
...
![](/images/nodejs/你不知道的npm-init/./6.png)

并且create-react-app会在下载使用完被删除

![](/images/nodejs/你不知道的npm-init/./7.png)
...
![](/images/nodejs/你不知道的npm-init/./8.png)
