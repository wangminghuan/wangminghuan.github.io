...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./1.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./2.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./4-1.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./4-2.png)
...
执行结果：
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./1.gif)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./9.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./2.gif)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./4.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./5.png)

也可结合业务实现自动更新，参见：[谨慎处理 Service Worker 的更新](https://zhuanlan.zhihu.com/p/51118741)，此处不再赘述。

接着上面的代码，重新执行后，点击按钮向service worker发送消息：

![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./6.png)
...
![](/images/javascript/Web-Worker-与-Service-Worker-以及CacheStorage使用指北/./7.png)
