...
![](/images/javascript/ES6系列-2-新增类型与扩展方法/1.png)
...
![](/images/javascript/ES6系列-2-新增类型与扩展方法/2.png)  
...
2. Map构造函数参数可以为空，数组或Set,Map等，任何具有 Iterator 接口、且每个成员都是一个双元素的数组的数据结构都可以当作Map构造函数的参数。
		...
		console.log(n);
![](/images/javascript/ES6系列-2-新增类型与扩展方法/3.png)
...
![](/images/javascript/ES6系列-2-新增类型与扩展方法/4.png)
...
![](/images/javascript/ES6系列-2-新增类型与扩展方法/5.png)  
我们可以这样解决：
