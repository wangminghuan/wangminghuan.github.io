...
![](/images/javascript/浅谈WebAssembly/./01.png)
...
![](/images/javascript/浅谈WebAssembly/./02.png)
...
![](/images/javascript/浅谈WebAssembly/./03.png)
...
![](/images/javascript/浅谈WebAssembly/./06.png)

我们看一个实际的demo : [通过wasm实现的一种视频播放器](https://roblin.cn/wasm/)

查看源码可以看到：

![](/images/javascript/浅谈WebAssembly/./07.jpg)

控制台里面有.wasm调用：

![](/images/javascript/浅谈WebAssembly/./08.png)

![](/images/javascript/浅谈WebAssembly/./09.png)
