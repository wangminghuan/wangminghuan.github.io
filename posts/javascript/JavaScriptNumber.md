...
![](/images/javascript/JavaScript中的Number与精度/0.png)

- s表示符号位，当s=0，V为正数；当s=1，V为负数。
- e表示指数位
- f表示小数位

![](/images/javascript/JavaScript中的Number与精度/1.png)
...
![](/images/javascript/JavaScript中的Number与精度/2.png)
...
![](/images/javascript/JavaScript中的Number与精度/3.png)

当符号位为0、指数取到-1022、小数位初最后一位全为0时，为可表示的最小正值 


![](/images/javascript/JavaScript中的Number与精度/3-1.png)


最大正值为 2^1024-1，转换为科学计数保存在Number.MAX_VALUE下：

![](/images/javascript/JavaScript中的Number与精度/4.png)
...
![](/images/javascript/JavaScript中的Number与精度/8.png)
...
![](/images/javascript/JavaScript中的Number与精度/5.png)

![](/images/javascript/JavaScript中的Number与精度/6.png)
