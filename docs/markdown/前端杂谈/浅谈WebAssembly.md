---
title: 浅谈WebAssembly
lastUpdated: 2019-12-24 16:38:07
---
# {{$frontmatter.title}}
...
![](./image/3972348116.png)

我们看一个实际的demo : [通过wasm实现的一种视频播放器](https://roblin.cn/wasm/)

查看源码可以看到：

![](./image/2070564781.jpg)

控制台里面有.wasm调用：

![](./image/8590093928.png)

![](./image/8000170922.png)
