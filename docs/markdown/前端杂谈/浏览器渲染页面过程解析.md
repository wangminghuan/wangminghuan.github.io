---
title: 浏览器渲染页面过程解析
lastUpdated: 2020-07-05 10:00:41
---
# {{$frontmatter.title}}
...
![](./image/5863982572.png)


各部分执行时间如下（从高到低）：

![](./image/4166198173.png)
