---
title: 你不知道的JS系列-2
lastUpdated: 2021-01-16 11:57:04
---
# {{ $frontmatter.title }}
...
![](./image/8978793811.png)
![](./image/8169646000.png)
![](./image/8249733183.png)
...
- `hasOwnProperty` 只会检查属性是否在当前对象中。
  - 如果担心myObejct.hasOwnProperty失败可以调用：Object.prototype.myObejct.call(hasOwnProperty)
